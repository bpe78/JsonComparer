...
namespace JsonComparer.WPF.Behaviors
{
    /// <summary>
    /// Original source : http://www.codeproject.com/Articles/28959/Introduction-to-Attached-Behaviors-in-WPF
    /// </summary>
    static class TreeViewItemBehavior
    {
